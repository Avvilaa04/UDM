    ...
    <main>
        <div class="summary-container">
            ...
            <div class="summary-details">
                ...
                <p><strong>Tipo de Función:</strong> <?php echo $tipo_funcion; ?></p>
                <p><strong>Cantidad de Boletos:</strong> <?php echo $cantidad_boletos; ?></p>
                <p><strong>Precio Base por Boleto:</strong> $<?php echo number_format($precio_base_boleto, 2); ?></p>
                <?php if ($descuento_porcentaje > 0): ?>
                    <p><strong>Descuento Aplicado:</strong> <?php echo ($descuento_porcentaje * 100); ?>%</p>
                    <p><strong>Precio con Descuento por Boleto:</strong> $<?php echo number_format($precio_boleto_con_descuento, 2); ?></p>
                <?php else: ?>
                    <p><strong>Descuento Aplicado:</strong> Ninguno</p>
                <?php endif; ?>
            </div>
